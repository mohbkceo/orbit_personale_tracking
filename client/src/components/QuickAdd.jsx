...
export function QuickAdd() {
  ...
  async function submit(event) {
    ...
    try {
      ...
      toast(`${types.find((item) => item.id === type).label} added`); setQuickAddOpen(false); setForm((v) => ({ ...v, amount: '', description: '', title: '' })); window.dispatchEvent(new Event('orbit:refresh'));
